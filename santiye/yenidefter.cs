        ...
        private void button2_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string komut2 = "INSERT INTO gelirgiderhareket(cariadi,islemtarihi,islemno,islemturu,tutar,parabirimi,kdv,kdvsiztutar,kdvlitutar,aciklama) values ('" + cariadi.Text + "','" + islemtarihi.Text + "','" + islemno.Text + "','" + "GELİR İŞLEMİ" + "','" + tutar.Text + "','" + parabirimi.Text + "','" + kdv.Text + "','" + label13.Text + "','" + tutar.Text + "','" + "" + "')";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string komut2 = "INSERT INTO gelirgiderhareket(cariadi,islemtarihi,islemno,islemturu,tutar,parabirimi,kdv,kdvsiztutar,kdvlitutar,aciklama) values ('" + cariadidiger.Text + "','" + islemtarihigider.Text + "','" + islemnogider.Text + "','" + "GİDER İŞLEMİ" + "','" + tutargider.Text + "','" + parabirimigider.Text + "','" + kdvgider.Text + "','" + label14.Text + "','" + tutargider.Text + "','" + "" + "')";
